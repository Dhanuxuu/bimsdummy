...
<div class="card-body p-4 p-md-5">
    ...
    <form method="POST" action="{{ route('auth/donoregister') }}">
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-outline">
                    <label for="fname" class="form-label">{{ __('Select ') }}</label>
                    ...
                    <select name="regtype" id="regtype" class="form-control">
                        <option value="Hospital" {{ old('role') == 'Hospital' ? 'selected' : '' }}>Hospital Registration</option>
                        <option value="BloodBank" {{ old('role') == 'BloodBank' ? 'selected' : '' }}>Blood Bank Registration</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-outline">
                    <label for="fname" class="form-label">{{ __('Hospital Name') }}</label>
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-outline">
                    <label for="nic" class="form-label">{{ __('HospitalID') }}</label>
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-outline">
                    <label for="address" class="form-label">{{ __('District') }}</label>
                    <input type="text" id="address" class="form-control form-control-lg" name="address" required/>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-outline">
                    <label for="city" class="form-label">{{ __('Province') }}</label>
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <div data-mdb-input-init class="form-outline">
                    <label for="lname" class="form-label">{{ __('Address') }}</label>
