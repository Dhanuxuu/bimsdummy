...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('master', function (Blueprint $table) {
            ...
            $table->foreign('blood_id')->references('blood_id')->on('blood_inventory')->onDelete('set null');
            $table->foreign('hbb_id')->references('hbb_id')->on('hospital_bb')->onDelete('set null');
          //  $table->foreign('HospitalID')->references('id')->on('hospitals')->onDelete('set null');
            $table->foreign('camp_id')->references('camp_id')->on('donation_camps')->onDelete('set null');
            $table->foreign('donation_id')->references('donation_id')->on('donations')->onDelete('set null');
            $table->foreign('donor_id')->references('donor_id')->on('donors')->onDelete('set null');
